<div class="min-h-screen bg-gray-100 dark:bg-gray-900">
    ...
    <div class="fixed left-0 top-0 w-80 h-full bg-gray-100 dark:bg-gray-800 dark:text-white p-4 z-50 sidebar-menu transition-transform">
        ...
        <a href="#" class="flex items-center pb-4 border-b border-b-gray-800 dark:border-b-gray-300">
            <img src="{{ asset('images/LOGO-KAPM.png') }}" alt="" class="h-24 rounded object-cover">
        </a>
        <p class="border-b-gray-800 py-6 border-b dark:border-b-gray-300 text-2xl font-bold">
            Surat Tugas Online
        </p>
        <ul class="mt-4">
            <li>
                ...
                <li>
                        <div x-data="window.themeSwitcher()" x-init="switchTheme()" @keydown.window.tab="switchOn = false" class="flex items-center justify-center space-x-2">
                            ...
                            <button
                                ...
                                <span :class="switchOn ? 'translate-x-[18px]' : 'translate-x-0.5'" class="w-5 h-5 duration-200 ease-in-out bg-white rounded-full shadow-md">
                                </span>
                            </button>

                            <label @click="$refs.switchButton.click(); $refs.switchButton.focus()" :id="$id('switch')"
                                :class="{ 'text-blue-600': switchOn, 'text-gray-400 hidden': ! switchOn }"
                            ...
                            <label @click="$refs.switchButton.click(); $refs.switchButton.focus()" :id="$id('switch')"
                                :class="{ 'text-blue-600 hidden': switchOn, 'text-gray-400': ! switchOn }"
                                class="text-sm select-none">
                                <svg
